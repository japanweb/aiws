...
function clearFile() {
    ...
    wsl sh -c "echo '#! /bin/bash' > /etc/init.wsl | echo 'systemctl start bt' >> /etc/init.wsl | echo '/etc/init.d/nginx' >> /etc/init.wsl | echo '/etc/init.d/mysqld' >> /etc/init.wsl | echo '/etc/init.d/pure-ftpd' >> /etc/init.wsl | echo 'systemctl start sshd' >> /etc/init.wsl | echo 'systemctl start dbus' >> /etc/init.wsl"
